...
CREATE SCHEMA "app";
--> statement-breakpoint
CREATE TYPE "app"."theory_attempt_result" AS ENUM('incorrect', 'partial', 'correct');--> statement-breakpoint
...
CREATE TABLE "auth"."custom_oauth_providers" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"custom_claims_allowlist" text[] DEFAULT '{""}' NOT NULL,
...
CREATE TABLE "app"."theory_categories" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "theory_categories_name_key" UNIQUE("name"),
	CONSTRAINT "theory_categories_slug_key" UNIQUE("slug"),
	CONSTRAINT "theory_categories_name_check" CHECK (length(btrim(name)) > 0),
	CONSTRAINT "theory_categories_slug_check" CHECK (length(btrim(slug)) > 0)
);
--> statement-breakpoint
...
CREATE TABLE "app"."theory_questions" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "theory_questions_answer_check" CHECK (length(btrim(answer)) > 0),
	CONSTRAINT "theory_questions_question_check" CHECK (length(btrim(question)) > 0)
);
--> statement-breakpoint
CREATE TABLE "app"."theory_sources" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "theory_sources_url_key" UNIQUE("url"),
	CONSTRAINT "theory_sources_title_check" CHECK (length(btrim(title)) > 0),
	CONSTRAINT "theory_sources_url_check" CHECK (length(btrim(url)) > 0)
);
--> statement-breakpoint
CREATE TABLE "app"."theory_question_categories" (
	"question_id" uuid NOT NULL,
	"category_id" uuid NOT NULL,
	CONSTRAINT "theory_question_categories_pkey" PRIMARY KEY("question_id","category_id")
);
--> statement-breakpoint
CREATE TABLE "app"."theory_library_items" (
	...
	"question_id" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "theory_library_items_pkey" PRIMARY KEY("profile_id","question_id")
);
--> statement-breakpoint
...
ALTER TABLE "app"."theory_attempts" ADD CONSTRAINT "theory_attempts_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "app"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."theory_attempts" ADD CONSTRAINT "theory_attempts_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "app"."theory_questions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."profiles" ADD CONSTRAINT "profiles_id_fkey" FOREIGN KEY ("id") REFERENCES "auth"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."theory_questions" ADD CONSTRAINT "theory_questions_owner_profile_id_fkey" FOREIGN KEY ("owner_profile_id") REFERENCES "app"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."theory_questions" ADD CONSTRAINT "theory_questions_source_id_fkey" FOREIGN KEY ("source_id") REFERENCES "app"."theory_sources"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."theory_question_categories" ADD CONSTRAINT "theory_question_categories_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "app"."theory_categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."theory_question_categories" ADD CONSTRAINT "theory_question_categories_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "app"."theory_questions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."theory_library_items" ADD CONSTRAINT "theory_library_items_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "app"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."theory_library_items" ADD CONSTRAINT "theory_library_items_question_id_fkey" FOREIGN KEY ("question_id") REFERENCES "app"."theory_questions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "webauthn_challenges_user_id_idx" ON "auth"."webauthn_challenges" USING btree ("user_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "theory_attempts_profile_question_created_at_idx" ON "app"."theory_attempts" USING btree ("profile_id" timestamptz_ops,"question_id" timestamptz_ops,"created_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "theory_attempts_question_id_idx" ON "app"."theory_attempts" USING btree ("question_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "theory_questions_owner_profile_id_idx" ON "app"."theory_questions" USING btree ("owner_profile_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "theory_questions_public_idx" ON "app"."theory_questions" USING btree ("created_at" timestamptz_ops) WHERE (is_public = true);--> statement-breakpoint
CREATE INDEX "theory_questions_source_id_idx" ON "app"."theory_questions" USING btree ("source_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "theory_question_categories_category_id_idx" ON "app"."theory_question_categories" USING btree ("category_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "theory_library_items_question_id_idx" ON "app"."theory_library_items" USING btree ("question_id" uuid_ops);
*/